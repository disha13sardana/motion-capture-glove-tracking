// This the latest version at 5:39 pm, Aug 27, 2018
...
namespace QualisysRealTime.Unity{
    ...
    public class Binaural_hands_headphones_v0: MonoBehaviour {
...
// CHANGES: Calculate angle with the -zDir and change right_hit.point.z < 0 to right_hit.point.x > 0, removed 90
                ...
                //print("Right hand" + right_azim_angle);
...
// CHANGES: Calculate angle with the -zDir and change _hit.point.z < 0 to _hit.point.x > 0, removed 90
       ...
       // }       
        ...
        //send binaural angles only when receive source angles from Max
        //if (source_azim_angle != -999)
        //{
        //    sendBinauralAngles(binaural_elev_angle_Zach, binaural_azim_angle_Zach);
        //}
