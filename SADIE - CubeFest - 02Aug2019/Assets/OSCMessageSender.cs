...
public class OSCMessageSender : MonoBehaviour {
    ...
    // public string externalIP = "172.29.106.209"; // the IP of the machine to which you want to send messages

    public string externalIP = "192.168.1.15"; // the IP of the machine to which you want to send messages

    public int externalPort = 8080; // the port on which the receiving machine will be listening for messages
